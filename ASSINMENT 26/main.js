...
// console.log("(version 01) Alien colour is yellow, player just earned 10 points");
...
//}else if (alien_colour === "yellow"){
//console.log("(version 02) Alien colour is yellow, player just earned 10 points");
//}else if (alien_colour === "red"){
...
if (alien_colour == "green") {
    ...
    console.log("(version 03) Alien colour is yellow, player just earned 10 points");
}
else if (alien_colour === "red") {
